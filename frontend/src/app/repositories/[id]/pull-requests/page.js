// File: frontend/src/app/repositories/[id]/pull-requests/page.js - REPLACE ENTIRE FILE
'use client';
          ...
          <div className="max-w-6xl mx-auto space-y-6">
            ...
            {pullRequests.length === 0 ? (
              <div className="bg-[#161616] border border-white/10 rounded-2xl p-16 text-center">
                ...
                <p className="text-white/50">This repository has no open pull requests</p>
              </div>
            ) : (
                      ...
                      <div className="flex items-start justify-between gap-4">
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-3 mb-2">
                            <h3 className="font-medium text-white">#{pr.number}: {pr.title}</h3>
                            <span className={`px-2 py-1 rounded-full text-xs font-medium border ${getStateColor(pr.state)}`}>
                          ...
                          <div className="flex items-center gap-4 text-sm">
                            ...
                            <span className="text-white/40">{pr.changed_files} files</span>
                          </div>
                        </div>
                        <div className="flex gap-2 shrink-0">
                          ...
                          <button 
                            ...
                            className="px-4 py-2 bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-500 hover:to-teal-500 text-white rounded-lg font-medium transition-all duration-200 flex items-center gap-2"
                          >
                            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">

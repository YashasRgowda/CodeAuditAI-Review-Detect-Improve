// File: frontend/src/app/repositories/[id]/page.js - REPLACE ENTIRE FILE
'use client';
        ...
        <main className="flex-1 p-6 lg:p-8">
          <div className="max-w-7xl mx-auto space-y-6">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1 min-w-0">
                <h1 className="text-3xl font-bold text-white truncate">{repository.repo_name}</h1>
                {repository.description && (
                  <p className="text-white/50 mt-1">{repository.description}</p>
                )}
              </div>
              <a href={repository.repo_url} target="_blank" rel="noopener noreferrer">
                <button className="px-4 py-2 bg-white/5 hover:bg-white/10 border border-white/10 text-white rounded-lg font-medium transition-all duration-200 flex items-center gap-2">
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <Link href={`/repositories/${repoId}/commits`} className="group relative">
                ...
                <div className="relative bg-[#161616] border border-white/10 rounded-2xl p-6 hover:border-violet-500/50 transition-all duration-300">
                  <div className="flex items-center gap-4 mb-3">
                    ...
                    <div>
                      <h3 className="text-lg font-semibold text-white">Commits</h3>
                      <p className="text-sm text-white/50">View recent commits</p>
                    </div>
                  </div>
                  <svg className="w-5 h-5 text-white/40 group-hover:text-white/60 transition-colors ml-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <Link href={`/repositories/${repoId}/pull-requests`} className="group relative">
                <div className="absolute -inset-0.5 bg-gradient-to-r from-emerald-600 to-teal-600 rounded-2xl blur opacity-0 group-hover:opacity-30 transition duration-300"></div>
                <div className="relative bg-[#161616] border border-white/10 rounded-2xl p-6 hover:border-emerald-500/50 transition-all duration-300">
                  <div className="flex items-center gap-4 mb-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-white/50">Review PRs</p>
                    </div>
                  </div>
                  <svg className="w-5 h-5 text-white/40 group-hover:text-white/60 transition-colors ml-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
              ...
              <Link href={`/repositories/${repoId}/analysis`} className="group relative">
                <div className="absolute -inset-0.5 bg-gradient-to-r from-amber-600 to-orange-600 rounded-2xl blur opacity-0 group-hover:opacity-30 transition duration-300"></div>
                <div className="relative bg-[#161616] border border-white/10 rounded-2xl p-6 hover:border-amber-500/50 transition-all duration-300">
                  <div className="flex items-center gap-4 mb-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-white/50">Past analyses</p>
                    </div>
                  </div>
                  <svg className="w-5 h-5 text-white/40 group-hover:text-white/60 transition-colors ml-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
            ...
            <div className="bg-[#161616] border border-white/10 rounded-2xl p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                <div className="flex justify-between items-center py-2 border-b border-white/5">
                  ...
                  <span className="text-white font-medium">{repository.repo_name}</span>
                </div>
                <div className="flex justify-between items-center py-2 border-b border-white/5">
                  <span className="text-white/50">Added:</span>
                  <span className="text-white font-medium">{formatDate(repository.created_at)}</span>
                </div>
                {repository.last_analyzed_at && (
                  <div className="flex justify-between items-center py-2 border-b border-white/5">
                    <span className="text-white/50">Last Analyzed:</span>
                    <span className="text-white font-medium">{formatDate(repository.last_analyzed_at)}</span>
                  </div>
                )}
              </div>
            </div>

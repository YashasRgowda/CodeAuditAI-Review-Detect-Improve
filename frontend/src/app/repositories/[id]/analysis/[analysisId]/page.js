// File: frontend/src/app/repositories/[id]/analysis/[analysisId]/page.js - REPLACE ENTIRE FILE
'use client';
        ...
        <aside className={`fixed lg:sticky top-[73px] left-0 h-[calc(100vh-73px)] z-30 bg-black/40 border-r border-white/5 backdrop-blur-xl transform transition-all duration-300 ${
          ...
          <nav className="p-4 space-y-2">
            ...
            <Link href="/analysis" className="group relative flex items-center gap-3 px-4 py-3 rounded-xl overflow-hidden transition-all duration-200">
              ...
              <span className={`font-medium text-white transition-all duration-300 relative z-10 ${sidebarCollapsed ? 'lg:opacity-0 lg:w-0' : 'opacity-100'}`}>Analysis</span>
            </Link>
                ...
                <div className="flex items-start justify-between mb-6">
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-3">
                      <span className={`px-4 py-1.5 rounded-full text-sm font-semibold border ${getRiskBadgeColor(analysis.risk_level)}`}>

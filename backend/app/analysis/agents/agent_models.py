# ============================================================================
# AGENTS/AGENT_MODELS.PY — Pydantic Schemas for Multi-Agent Analysis
# ============================================================================
# Defines request/response shapes for the multi-agent analysis endpoints:
#
#   - MultiAgentAnalysisRequest: Input for triggering multi-agent commit analysis
#   - MultiAgentPRAnalysisRequest: Input for triggering multi-agent PR analysis
#   - AgentReport: Individual agent's detailed findings
#   - MultiAgentAnalysisResponse: Full combined response with agent breakdown
#
# The response includes the same top-level fields as the single-agent analysis
# (for backward compatibility) PLUS an `agent_reports` section with deep
# specialist insights from each agent.
# ============================================================================
...
class MultiAgentAnalysisResponse(BaseModel):
    ...
    # NEW: Individual agent reports with deep specialist insights
